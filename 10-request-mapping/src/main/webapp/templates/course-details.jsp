		...
		<div class="row">
			...
			<div class="col-4">
				...
				<form action="#" method="get">
					...
					<div class="mb-3">
						<label class="form-label mb-1" for="id">Id</label> <input id="id"
							name="id" type="text" value="${course.id}" class="form-control"
							readonly="readonly" />
					</div>
					...
					<div class="mb-3">
						<label for="level" class="form-label mb-1">Level</label> <input
							id="level" name="level" type="text" value="${course.level}"
							class="form-control" readonly="readonly" />
					</div>

					<div class="mb-3">
						<label for="duration" class="form-label mb-1">Duration</label> <input
					...
					<div class="mb-3">
						<label for="fees" class="form-label mb-1">Fees</label> <input
